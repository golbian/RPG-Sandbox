module.exports = function (app) {
    ...
    app.post('/api/admin/users/create', restrict, users.UsersCreate);
    ...
    app.get('/api/get-user-games/:id', restrict, users.getUserGames);
    app.get('/api/get-user-maps/:id', restrict, users.getUserMaps);
