angular.module('app').controller('mapCtrl', function ($scope, connection, $compile, $routeParams, $timeout) {
    $scope.promptsBlock = 'partials/map/partials/promptsBlock.html';
    $scope.dateModal = 'partials/map/modals/dateModal.html';
    $scope.linkModal = 'partials/map/modals/linkModal.html';
