        ...
        steps: [
            {
                intro: '<h4>' +
                    ...
                    '</h4><p><strong>' +
                    gettextCatalog.getString('The shared space is the place where you or your users will publish maps to be available for other users or the hole company.') +
                    '</strong></p><p>' +
                    gettextCatalog.getString('Here you can define the structure in folders of the shared space.') +
                    '</p><p>' +
                    gettextCatalog.getString('Later using roles you can grant or deny access to the different folders of the shared space to users that have the appropriate role to execute or share maps along the shared space.') +
                    '</p>',
            },
            {
